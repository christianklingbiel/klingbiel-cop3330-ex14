...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println("What is the order amount? "); double amount = in.nextDouble();
        System.out.println("What is the state? "); String state = in.next();
        if(state.equalsIgnoreCase("WI")) {
            System.out.println("The subtotal is $" + amount);
            System.out.println("The tax is $" + (amount * 0.055));
            amount = amount * 1.055;
        }
